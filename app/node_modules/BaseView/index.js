...
BaseView.prototype.initWinClose = function () {
  this.$('#window-close-btn').on('click', (function () {
    this.win.close();
  }).bind(this));
};

BaseView.prototype.initWinHide = function () {
  this.$('#window-hide-btn').on('click', (function () {
    this.win.minimize();
  }).bind(this));
};
